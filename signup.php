...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($last_name)) {
     ...
     //Validation username
     if(empty($username)) {
        $usernameE = 'First name is required to signup';
    } elseif(is_numeric($username)) {
        $usernameE = 'Enter a valid first name';
    }
    ...
    } elseif($password == $first_name || $password == $last_name || $password == $username) {
        $passwordE = 'Weak password';
...
<body>
    <form action="" method="post">
        ...
        <input type="submit" value="Sign-up" style="background-color: pink;">
    </form>
</body>
</html>